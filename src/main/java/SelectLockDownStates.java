...
public class SelectLockDownStates {
    ...
    public static void main(String[] args) throws IOException, ClassNotFoundException, InterruptedException {
        ...
        job2.setJarByClass(SelectLockDownStates.class);
...
//        job2.setReducerClass(NarrowUSStates.class);
        ...
        FileOutputFormat.setOutputPath(job2, new Path(args[0] + "/SelectTargetLocations/selectLockDownStates"));
